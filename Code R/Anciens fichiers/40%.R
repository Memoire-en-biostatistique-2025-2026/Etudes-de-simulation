...
# |:----|:-------|:----------------------------------------|:--------------------------------------|
# |1000 |RegLog  |MCSE_bias         , 0.0070784614337152   |Bias             , 0.164105717447206   |
# |-    |-       |MCSE_var           , 0.00169973916098816 |Var               , 0.0250523081342968 |
# |-    |-       |MCSE_mse           , 0.00345714593605894 |Mse               , 0.0519328900168904 |
# |-    |-       |%Cov, 0.76                               |Précision_var     , 0.0152197604938974 |
...
# |n    |Methode |Erreur de Monte Carlo                    |Autres                                     |
# |:----|:-------|:----------------------------------------|:------------------------------------------|
# |1000 |IPW     |MCSE_bias          , 0.00795163786760671 |Bias             , 0.154790879776759       |
# |-    |-       |MCSE_var           , 0.00293868645799097 |Var               , 0.0316142723887785     |
# |-    |-       |MCSE_mse           , 0.00345714593605894 |Mse               , 0.0519328900168904     |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:--------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_RF |MCSE_bias          , 0.00832073027098951 |Bias              , 0.0968198505153305 |
# |-    |-        |MCSE_var           , 0.00252116435971611 |Var               , 0.0346172761212806 |
# |-    |-        |MCSE_mse           , 0.00311619240605604 |Mse              , 0.043922125022849   |
# |-    |-        |%Cov, 0.99                               |Précision_var    , 0.249748588772906   |
...
# |n    |Methode     |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:-----------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_Lasso |MCSE_bias         , 0.0199771671959782   |Bias              , -0.114470096930681 |
# |-    |-           |MCSE_var           , 0.00780221995031779 |Var              , 0.199543604588034   |
# |-    |-           |MCSE_mse           , 0.00359939802923912 |Mse              , 0.212247920470177   |
# |-    |-           |%Cov , 0.998                             |Précision_var   , -2221.1285596788     |
...
# |n    |Methode    |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:----------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_Mars |MCSE_bias         , 0.0142112836308242   |Bias              , 0.0554470446578002 |
# |-    |-          |MCSE_var           , 0.00456103049194163 |Var              , 0.100980291217865   |
# |-    |-          |MCSE_mse           , 0.00480307380794512 |Mse              , 0.103852705396714   |
# |-    |-          |%Cov , 0.966                             |Précision_var    , -139.726757419715   |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:--------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_RN |MCSE_bias         , 0.0179417688948937   |Bias              , -0.131803870684131 |
# |-    |-        |MCSE_var           , 0.00753628032831247 |Var              , 0.160953535538888   |
# |-    |-        |MCSE_mse           , 0.00401626503483218 |Mse              , 0.178003888795129   |
# |-    |-        |%Cov , 0.856                             |Précision_var    , -4.36663046097162   |
