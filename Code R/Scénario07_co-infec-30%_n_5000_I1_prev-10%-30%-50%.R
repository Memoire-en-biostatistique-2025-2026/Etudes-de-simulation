...
for (i in 1:nsim) {
  ...
  dat <- datagen(seed = seeds_list[i], ssize = 5000, I1_prev = 0.1,
                 co_inf_para1 = 1, co_inf_para2 = 2)
  tryCatch({
...
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |RegLog  |MCSE_bias          , 0.00262156535117855   |Bias              , 0.0902221534224387   |
# |-    |-       |MCSE_var            , 0.000380500413601458 |Var                , 0.00687260489049989 |
# |-    |-       |MCSE_mse          , 0.0007099078275133     |Mse               , 0.0150057692537915   |
# |-    |-       |%Cov , 0.749                               |Précision_var     , 0.0159837508761455   |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                 |
# |:----|:-------|:------------------------------------------|:--------------------------------------|
# |5000 |IPW     |MCSE_bias          , 0.00274229760235241   |Bias              , 0.0621763746578546 |
# |-    |-       |MCSE_var            , 0.000400195062029734 |Var               , 0.0075201961398678 |
# |-    |-       |MCSE_mse          , 0.0007099078275133     |Mse               , 0.0150057692537915 |
# |-    |-       |%Cov , 0.857                               |Précision_var     , 0.0179493722051925 |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00285863720701394   |Bias             , 0.047326895934943     |
# |-    |-        |MCSE_var            , 0.000446128415372669 |Var                , 0.00817180668132447 |
# |-    |-        |MCSE_mse            , 0.000600256235859733 |Mse               , 0.0104034699534801   |
# |-    |-        |%Cov , 0.929                               |Précision_var     , 0.0158991381453795   |
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias          , 0.00278703950120278   |Bias              , 0.0479484060993806   |
# |-    |-           |MCSE_var            , 0.000414696050662773 |Var                , 0.00776758918126465 |
# |-    |-           |MCSE_mse            , 0.000565875074403627 |Mse               , 0.0100588712395545   |
# |-    |-           |%Cov , 0.788                               |Précision_var     , 0.0663705279081028   |
...
# |n    |Methode    |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:----------|:----------------------------------------|:--------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias          , 0.00526909255049621 |Bias              , 0.0124192953443255 |
# |-    |-          |MCSE_var           , 0.00173872216953561 |Var               , 0.0277633363056947 |
# |-    |-          |MCSE_mse           , 0.00171554076194273 |Mse               , 0.0278898118662386 |
# |-    |-          |%Cov , 0.938                             |Précision_var    , 0.234432540433329   |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:--------|:----------------------------------------|:--------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias          , 0.00849070811680765 |Bias              , -0.087450107572302 |
# |-    |-        |MCSE_var           , 0.00259132273023377 |Var               , 0.0720921243248233 |
# |-    |-        |MCSE_mse           , 0.00278606329305153 |Mse               , 0.0796675535149057 |
# |-    |-        |%Cov , 0.914                             |Précision_var     , 0.0475549005581093 |
...
# |n    |Methode   |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:---------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_GLM |MCSE_bias          , 0.00276034611133646   |Bias              , 0.0532769233433722   |
# |-    |-         |MCSE_var            , 0.000374161909651744 |Var                , 0.00761951065437034 |
# |-    |-         |MCSE_mse            , 0.000549220963677849 |Mse               , 0.0104503217046515   |
# |-    |-         |%Cov , 0.928                               |Précision_var      , 0.00975510080611836 |
...
for (i in 1:nsim) {
  ...
  dat <- datagen(seed = seeds_list[i], ssize = 5000, I1_prev = 0.3,
                 co_inf_para1 = 1, co_inf_para2 = -1)
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |RegLog  |MCSE_bias          , 0.00130453723634005   |Bias             , 0.107300197682954     |
# |-    |-       |MCSE_var            , 8.08218709274508e-05 |Var                , 0.00170181740099772 |
# |-    |-       |MCSE_mse            , 0.000304441841692119 |Mse               , 0.0132134480063977   |
# |-    |-       |%Cov , 0.125                               |Précision_var    , 0.007182095572078     |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |IPW     |MCSE_bias          , 0.00130232394038686   |Bias              , 0.0841167983563432   |
# |-    |-       |MCSE_var            , 7.76578682643263e-05 |Var                , 0.00169604764570476 |
# |-    |-       |MCSE_mse            , 0.000304441841692119 |Mse               , 0.0132134480063977   |
# |-    |-       |%Cov , 0.333                               |Précision_var      , 0.00691295415472719 |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00133284755339994   |Bias              , 0.0773733395079213   |
# |-    |-        |MCSE_var           , 8.2485085337699e-05   |Var                , 0.00177648260060421 |
# |-    |-        |MCSE_mse            , 0.000231791772389631 |Mse                , 0.00776133978461165 |
# |-    |-        |%Cov , 0.475                               |Précision_var      , 0.00900521282408516 |
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias          , 0.00130686320901473   |Bias              , 0.0828396869588631   |
# |-    |-           |MCSE_var            , 7.76679898176894e-05 |Var                , 0.00170789144707628 |
# |-    |-           |MCSE_mse            , 0.000240890432859715 |Mse                , 0.00856859729107164 |
# |-    |-           |%Cov , 0.221                               |Précision_var     , 0.0251066747024442   |
...
# |n    |Methode    |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias          , 0.00227748461594611   |Bias              , 0.0738185263709189   |
# |-    |-          |MCSE_var            , 0.000774284651201027 |Var                , 0.00518693617587121 |
# |-    |-          |MCSE_mse            , 0.000685764247465935 |Mse               , 0.0106309240752694   |
# |-    |-          |%Cov , 0.542                               |Précision_var   , 0.46016021178125       |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias          , 0.00263644950552552   |Bias              , 0.0686808299344227   |
# |-    |-        |MCSE_var           , 0.00103437179385185   |Var                , 0.00695086599518577 |
# |-    |-        |MCSE_mse            , 0.000769620626531444 |Mse               , 0.0116609715296717   |
# |-    |-        |%Cov , 0.516                               |Précision_var    , 0.718770720093327     |
...
# |n    |Methode   |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:---------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_GLM |MCSE_bias          , 0.00129749571191745   |Bias             , 0.082710632996659     |
# |-    |-         |MCSE_var            , 7.81884419944678e-05 |Var                , 0.00168349512244418 |
# |-    |-         |MCSE_mse            , 0.000240769083420139 |Mse                , 0.00852286043802974 |
# |-    |-         |%Cov , 0.431                               |Précision_var      , 0.00540177308693313 |
...
for (i in 1:nsim) {
  ...
  dat <- datagen(seed = seeds_list[i], ssize = 5000, I1_prev = 0.5,
                 co_inf_para1 = 1.5, co_inf_para2 = -1.5)
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |RegLog  |MCSE_bias          , 0.00123848095719049   |Bias             , 0.136892106933154     |
# |-    |-       |MCSE_var            , 6.88305167280878e-05 |Var                , 0.00153383508132346 |
# |-    |-       |MCSE_mse            , 0.000357773037261425 |Mse               , 0.0202717501868403   |
# |-    |-       |%Cov, 0.01                                 |Précision_var      , 0.00341575134238144 |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |IPW     |MCSE_bias          , 0.00122529902694935   |Bias             , 0.113020683157034     |
# |-    |-       |MCSE_var            , 6.54585404639208e-05 |Var                , 0.00150135770544302 |
# |-    |-       |MCSE_mse            , 0.000357773037261425 |Mse               , 0.0202717501868403   |
# |-    |-       |%Cov , 0.092                               |Précision_var      , 0.00328681032499804 |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00126023940832121   |Bias             , 0.107530879787076     |
# |-    |-        |MCSE_var            , 7.03048269707869e-05 |Var                , 0.00158820336628579 |
# |-    |-        |MCSE_mse            , 0.000294250399966891 |Mse               , 0.0131495052707022   |
# |-    |-        |%Cov, 0.17                                 |Précision_var      , 0.00462062662433115 |
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias         , 0.0012309324519152     |Bias             , 0.112409592279139     |
# |-    |-           |MCSE_var            , 6.56734707304071e-05 |Var                , 0.00151519470117796 |
# |-    |-           |MCSE_mse            , 0.000295108951409805 |Mse              , 0.014149595942839     |
# |-    |-           |%Cov , 0.048                               |Précision_var     , 0.0171378011084762   |
...
# |n    |Methode    |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias          , 0.00205260093365839   |Bias             , 0.107232759173634     |
# |-    |-          |MCSE_var            , 0.000654858223930972 |Var                , 0.00421317059285529 |
# |-    |-          |MCSE_mse            , 0.000612140043279846 |Mse               , 0.0157078220622531   |
# |-    |-          |%Cov, 0.24                                 |Précision_var    , 0.315514514542073     |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias          , 0.00145303544827262   |Bias             , 0.108128691038128     |
# |-    |-        |MCSE_var            , 0.000313968658126168 |Var                , 0.00211131201393682 |
# |-    |-        |MCSE_mse            , 0.000344256106073853 |Mse               , 0.0138010145275417   |
# |-    |-        |%Cov , 0.183                               |Précision_var    , 0.139507207480897     |
...
# |n    |Methode   |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:---------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_GLM |MCSE_bias         , 0.0012433257994322     |Bias             , 0.111914262753739     |
# |-    |-         |MCSE_var            , 6.70931151620852e-05 |Var                , 0.00154585904353371 |
# |-    |-         |MCSE_mse            , 0.000297973782904289 |Mse               , 0.0140691153922031   |
# |-    |-         |%Cov , 0.133                               |Précision_var      , 0.00344678843421049 |