...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |1000 |TNDDR_Lasso |MCSE_bias          , 0.00282737306755708   |Bias             , 0.042568988464431     |
# |-    |-           |MCSE_var            , 0.000389972861412695 |Var                , 0.00799403846314713 |
# |-    |-           |MCSE_mse            , 0.000521589883140391 |Mse                , 0.00979816320356885 |
# |-    |-           |%Cov , 0.607                               |Précision_var     , 0.0992129293810731   |
...
# |n    |Methode   |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:---------|:----------------------------------------|:----------------------------------------|
# |1000 |TNDDR_GLM |MCSE_bias         , 0.0129479312055783   |Bias               , -0.0355014422151186 |
# |-    |-         |MCSE_var           , 0.00376117169411654 |Var             , 0.16764892250439       |
# |-    |-         |MCSE_mse           , 0.00327562247068143 |Mse              , 0.168741625981239     |
# |-    |-         |%Cov, 1                                  |Précision_var    , -4.32932256822932     |