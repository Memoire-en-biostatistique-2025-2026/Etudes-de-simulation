...
for (i in 1:nsim) {
  ...
  dat <- datagen(seed = seeds_list[i], ssize = 5000, CV = 0.15,
...
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |RegLog  |MCSE_bias          , 0.00240330639677314   |Bias             , 0.114785684347962     |
# |-    |-       |MCSE_var            , 0.000264832653805212 |Var                , 0.00577588163677071 |
# |-    |-       |MCSE_mse            , 0.000674632093728158 |Mse              , 0.018945859086364     |
# |-    |-       |%Cov, 0.5                                  |Précision_var     , 0.0231971843422438   |
################################ IPW ###########################################
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                 |
# |:----|:-------|:------------------------------------------|:--------------------------------------|
# |5000 |IPW     |MCSE_bias          , 0.00242750019982743   |Bias              , 0.0998165672971633 |
# |-    |-       |MCSE_var           , 0.00027333877021793   |Var               , 0.0058927572201622 |
# |-    |-       |MCSE_mse            , 0.000674632093728158 |Mse              , 0.018945859086364   |
# |-    |-       |%Cov , 0.609                               |Précision_var     , 0.0237639608339032 |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                 |
# |:----|:--------|:------------------------------------------|:--------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00334101577458622   |Bias              , 0.0764219679845992 |
# |-    |-        |MCSE_var            , 0.000738791099180234 |Var              , 0.011162386406034   |
# |-    |-        |MCSE_mse           , 0.00086594488042061   |Mse               , 0.0169915412102671 |
# |-    |-        |%Cov , 0.815                               |Précision_var    , 0.224320168725075   |
...
# |n    |Methode     |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:-----------|:----------------------------------------|:--------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias          , 0.00694561146338008 |Bias              , 0.0861120675120655 |
# |-    |-           |MCSE_var           , 0.00201380164127535 |Var               , 0.0482415186002367 |
# |-    |-           |MCSE_mse           , 0.00211352238628394 |Mse              , 0.055608565252839   |
# |-    |-           |%Cov , 0.818                             |Précision_var   , -1.1192906240961     |
...
# |n    |Methode    |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:----------|:----------------------------------------|:--------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias          , 0.00620909502568607 |Bias              , 0.0371805581801326 |
# |-    |-          |MCSE_var          , 0.0021129139249436   |Var               , 0.0385528610379995 |
# |-    |-          |MCSE_mse           , 0.00206100229555489 |Mse               , 0.0398967020835477 |
# |-    |-          |%Cov , 0.911                             |Précision_var    , 0.586869217260683   |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                     |
# |:----|:--------|:----------------------------------------|:------------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias          , 0.00711106961740231 |Bias                , -0.00166307065713395 |
# |-    |-        |MCSE_var           , 0.00222967854978802 |Var               , 0.0505673111035422     |
# |-    |-        |MCSE_mse           , 0.00223621630598223 |Mse               , 0.0505195095964493     |
# |-    |-        |%Cov , 0.868                             |Précision_var    , -0.77870549573093       |
################################################################################
################################################################################
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |RegLog  |MCSE_bias          , 0.00170580255872647   |Bias             , 0.113441130946681     |
# |-    |-       |MCSE_var            , 0.000133938262842355 |Var                , 0.00290976236935777 |
# |-    |-       |MCSE_mse            , 0.000432760351177748 |Mse               , 0.0157757427974504   |
# |-    |-       |%Cov, 0.22                                 |Précision_var     , 0.0201964106881177   |
################################ IPW ###########################################
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |IPW     |MCSE_bias          , 0.00176863520970095   |Bias              , 0.0868127367349568   |
# |-    |-       |MCSE_var            , 0.000143949071298746 |Var                , 0.00312807050499393 |
# |-    |-       |MCSE_mse            , 0.000432760351177748 |Mse               , 0.0157757427974504   |
# |-    |-       |%Cov , 0.505                               |Précision_var     , 0.0129966430972609   |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00184115509976856   |Bias              , 0.0839960039605492   |
# |-    |-        |MCSE_var            , 0.000153957247679774 |Var                , 0.00338985210140379 |
# |-    |-        |MCSE_mse            , 0.000367630672457011 |Mse              , 0.010441790930643     |
# |-    |-        |%Cov , 0.509                               |Précision_var     , 0.0297190116296657   |
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                 |
# |:----|:-----------|:------------------------------------------|:--------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias          , 0.00316358186281718   |Bias              , 0.0944630126417745 |
# |-    |-           |MCSE_var            , 0.000455050727714635 |Var               , 0.0100082502027458 |
# |-    |-           |MCSE_mse            , 0.000801533996352347 |Mse               , 0.0189215027099031 |
# |-    |-           |%Cov , 0.758                               |Précision_var     , 0.0283567080494619 |
################################################################################
...
# |n    |Methode    |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:----------|:----------------------------------------|:--------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias          , 0.00363758147118237 |Bias              , 0.0726014705401477 |
# |-    |-          |MCSE_var           , 0.00129660351773751 |Var               , 0.0132319989594893 |
# |-    |-          |MCSE_mse           , 0.00125949752180015 |Mse               , 0.0184897404851217 |
# |-    |-          |%Cov , 0.663                             |Précision_var    , 0.582380637414296   |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:--------|:----------------------------------------|:--------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias          , 0.00531041109897632 |Bias              , 0.0570439737517115 |
# |-    |-        |MCSE_var           , 0.00204145539976795 |Var               , 0.0282004660401309 |
# |-    |-        |MCSE_mse           , 0.00183239400189103 |Mse               , 0.0314262805154767 |
# |-    |-        |%Cov , 0.623                             |Précision_var    , 0.835088548444357   |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |RegLog  |MCSE_bias          , 0.00185167656895583   |Bias             , 0.117556895387851     |
# |-    |-       |MCSE_var            , 0.000154809410342617 |Var                , 0.00342870611602003 |
# |-    |-       |MCSE_mse            , 0.000494665482430903 |Mse               , 0.0172449010631342   |
# |-    |-       |%Cov, 0.26                                 |Précision_var     , 0.0223567732876053   |
################################ IPW ###########################################
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |IPW     |MCSE_bias          , 0.00195532615246028   |Bias              , 0.0857554974362157   |
# |-    |-       |MCSE_var            , 0.000176341678319404 |Var                , 0.00382330036249513 |
# |-    |-       |MCSE_mse            , 0.000494665482430903 |Mse               , 0.0172449010631342   |
# |-    |-       |%Cov , 0.594                               |Précision_var     , 0.0113772999708081   |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                 |
# |:----|:--------|:------------------------------------------|:--------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00219820605167757   |Bias              , 0.0773143193308095 |
# |-    |-        |MCSE_var            , 0.000263463597804635 |Var               , 0.0048321098456319 |
# |-    |-        |MCSE_mse            , 0.000474692940910402 |Mse               , 0.0108047817093726 |
# |-    |-        |%Cov , 0.647                               |Précision_var     , 0.0397776427849472 |
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                 |
# |:----|:-----------|:------------------------------------------|:--------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias          , 0.00287757883463326   |Bias              , 0.0968822730741936 |
# |-    |-           |MCSE_var            , 0.000412953461134275 |Var               , 0.0082804599495293 |
# |-    |-           |MCSE_mse            , 0.000777441406198222 |Mse               , 0.0176583543256024 |
# |-    |-           |%Cov , 0.653                               |Précision_var     , 0.0474536977003922 |
...
# |n    |Methode    |Erreur de Monte Carlo                      |Autres                                 |
# |:----|:----------|:------------------------------------------|:--------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias          , 0.00319120939275281   |Bias              , 0.0813216254517906 |
# |-    |-          |MCSE_var            , 0.000894519724187217 |Var               , 0.0101838173883938 |
# |-    |-          |MCSE_mse           , 0.00106939190127348   |Mse               , 0.0167868403371267 |
# |-    |-          |%Cov , 0.684                               |Précision_var    , 0.330184033431647   |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:--------|:----------------------------------------|:--------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias          , 0.00638251284234125 |Bias              , 0.0553564271802355 |
# |-    |-        |MCSE_var         , 0.002458455742999     |Var              , 0.040736470182651   |
# |-    |-        |MCSE_mse           , 0.00225786371254839 |Mse               , 0.0437600677426291 |
# |-    |-        |%Cov , 0.627                             |Précision_var   , 1.50972791862362     |
