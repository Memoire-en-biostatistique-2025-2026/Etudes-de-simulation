...
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |1000 |RegLog  |MCSE_bias          , 0.00251989072231298   |Bias             , 0.107106600447605     |
# |-    |-       |MCSE_var            , 0.000309202701104621 |Var                , 0.00634984925239901 |
# |-    |-       |MCSE_mse            , 0.000696430438876688 |Mse               , 0.0178153232625894   |
# |-    |-       |%Cov , 0.658                               |Précision_var     , 0.0092094274263842   |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |1000 |IPW     |MCSE_bias          , 0.00250389829147557   |Bias             , 0.101427217263822     |
# |-    |-       |MCSE_var            , 0.000316025837147249 |Var                , 0.00626950665405426 |
# |-    |-       |MCSE_mse            , 0.000696430438876688 |Mse               , 0.0178153232625894   |
# |-    |-       |%Cov , 0.687                               |Précision_var      , 0.00822675198668388 |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |1000 |TNDDR_RF |MCSE_bias         , 0.0025751940399107     |Bias              , 0.0906595475087015   |
# |-    |-        |MCSE_var           , 0.00032999319709797   |Var                , 0.00663162434319157 |
# |-    |-        |MCSE_mse            , 0.000646086426104909 |Mse               , 0.0148441462733309   |
# |-    |-        |%Cov , 0.855                               |Précision_var      , 0.00350622066998627 |
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |1000 |TNDDR_Lasso |MCSE_bias         , 0.0025761546896083     |Bias             , 0.112430388340623     |
# |-    |-           |MCSE_var            , 0.000319854816799817 |Var                , 0.00663657298479085 |
# |-    |-           |MCSE_mse            , 0.000737532638092036 |Mse               , 0.0192705286342294   |
# |-    |-           |%Cov , 0.497                               |Précision_var    , 0.050905743257602     |
...
# |n    |Methode    |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:----------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_Mars |MCSE_bias          , 0.00507878617543641 |Bias              , 0.0794710444890655 |
# |-    |-          |MCSE_var           , 0.00186522349163497 |Var              , 0.025794069015804   |
# |-    |-          |MCSE_mse           , 0.00194207316838364 |Mse               , 0.0320839218589712 |
# |-    |-          |%Cov , 0.897                             |Précision_var    , 0.340597455772655   |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:--------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_RN |MCSE_bias          , 0.00700332492690193 |Bias              , 0.0434795488542358 |
# |-    |-        |MCSE_var           , 0.00251519642575219 |Var               , 0.0490465600317659 |
# |-    |-        |MCSE_mse           , 0.00248196887392908 |Mse              , 0.050887984640302   |
# |-    |-        |%Cov , 0.905                             |Précision_var   , 1.30818939041323     |
...
# |n    |Methode   |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:---------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_GLM |MCSE_bias          , 0.00893499246709597 |Bias             , 0.134065389370822   |
# |-    |-         |MCSE_var          , 0.0032673213044222   |Var               , 0.0798340903870617 |
# |-    |-         |MCSE_mse           , 0.00349823652180169 |Mse               , 0.0977277849238247 |
# |-    |-         |%Cov , 0.797                             |Précision_var    , 0.213829703799559   |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |1000 |RegLog  |MCSE_bias          , 0.00268014061287048   |Bias             , 0.103843746920275     |
# |-    |-       |MCSE_var            , 0.000365967252391706 |Var                , 0.00718315370475774 |
# |-    |-       |MCSE_mse            , 0.000767599472239457 |Mse              , 0.017959494325495     |
# |-    |-       |%Cov , 0.692                               |Précision_var     , 0.0135632431621822   |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |1000 |IPW     |MCSE_bias          , 0.00265718594842835   |Bias              , 0.0937309465804424   |
# |-    |-       |MCSE_var            , 0.000358372996264956 |Var                , 0.00706063716452509 |
# |-    |-       |MCSE_mse            , 0.000767599472239457 |Mse              , 0.017959494325495     |
# |-    |-       |%Cov , 0.755                               |Précision_var     , 0.0122460832963607   |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |1000 |TNDDR_RF |MCSE_bias          , 0.00275782523116618   |Bias             , 0.083345459102018     |
# |-    |-        |MCSE_var            , 0.000374094887071555 |Var                , 0.00760560000565682 |
# |-    |-        |MCSE_mse            , 0.000674537821058393 |Mse               , 0.0145444599585773   |
# |-    |-        |%Cov , 0.876                               |Précision_var      , 0.00912779536161271 |
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |1000 |TNDDR_Lasso |MCSE_bias         , 0.0029119728619492     |Bias             , 0.107412455513339     |
# |-    |-           |MCSE_var            , 0.000564206481364467 |Var                , 0.00847958594872862 |
# |-    |-           |MCSE_mse            , 0.000856355807053348 |Mse               , 0.0200085419621849   |
# |-    |-           |%Cov , 0.469                               |Précision_var    , 0.186319823273332     |
...
# |n    |Methode    |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:----------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_Mars |MCSE_bias          , 0.00523839988854172 |Bias              , 0.0694878180771192 |
# |-    |-          |MCSE_var           , 0.00185895367560865 |Var               , 0.0274408333922739 |
# |-    |-          |MCSE_mse           , 0.00196459792365954 |Mse               , 0.0322419494200004 |
# |-    |-          |%Cov , 0.926                             |Précision_var    , 0.656143321060186   |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:--------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_RN |MCSE_bias          , 0.00794462838065428 |Bias              , 0.0196308370338002 |
# |-    |-        |MCSE_var           , 0.00270970434749741 |Var               , 0.0631171201066975 |
# |-    |-        |MCSE_mse          , 0.0026905834053002   |Mse               , 0.0634393727492384 |
# |-    |-        |%Cov , 0.922                             |Précision_var   , 1.22230292590685     |
...
# |n    |Methode   |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:---------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_GLM |MCSE_bias         , 0.0127559595089909   |Bias              , -0.172106106355728 |
# |-    |-         |MCSE_var           , 0.00635651207568713 |Var              , 0.162714502995016   |
# |-    |-         |MCSE_mse           , 0.00256061715492052 |Mse             , 0.19217230033695     |
# |-    |-         |%Cov, 1                                  |Précision_var    , -13.4615179573452   |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |1000 |RegLog  |MCSE_bias         , 0.0027547887422733     |Bias              , 0.0803164388893552   |
# |-    |-       |MCSE_var            , 0.000418659800447187 |Var                , 0.00758886101455569 |
# |-    |-       |MCSE_mse            , 0.000724637113353149 |Mse               , 0.0140320025094087   |
# |-    |-       |%Cov , 0.845                               |Précision_var     , 0.0032444773941081   |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |1000 |IPW     |MCSE_bias          , 0.00288727391705082   |Bias              , 0.0683918380715395   |
# |-    |-       |MCSE_var            , 0.000477708190981649 |Var              , 0.008336350672082     |
# |-    |-       |MCSE_mse            , 0.000724637113353149 |Mse               , 0.0140320025094087   |
# |-    |-       |%Cov , 0.878                               |Précision_var      , 0.00599595336887607 |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |1000 |TNDDR_RF |MCSE_bias         , 0.0029715514031271     |Bias              , 0.0525792884232194   |
# |-    |-        |MCSE_var           , 0.00051272162484589   |Var                , 0.00883011774142663 |
# |-    |-        |MCSE_mse            , 0.000681157360503797 |Mse               , 0.0115858691947773   |
# |-    |-        |%Cov , 0.958                               |Précision_var      , 0.00240241940050803 |
...
# |n    |Methode     |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:-----------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_Lasso |MCSE_bias         , 0.0061954502723494   |Bias              , 0.0987990323460353 |
# |-    |-           |MCSE_var           , 0.00217919570283948 |Var               , 0.0383836040771542 |
# |-    |-           |MCSE_mse           , 0.00210679508057384 |Mse             , 0.04810646926559     |
# |-    |-           |%Cov , 0.618                             |Précision_var    , 0.638648958110405   |
...
# |n    |Methode    |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:----------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_Mars |MCSE_bias          , 0.00588031927124728 |Bias              , 0.0276136691470561 |
# |-    |-          |MCSE_var           , 0.00209579007742343 |Var               , 0.0345781547318022 |
# |-    |-          |MCSE_mse           , 0.00214087666204538 |Mse               , 0.0353060913008334 |
# |-    |-          |%Cov , 0.945                             |Précision_var    , 0.705203737401186   |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:--------|:----------------------------------------|:----------------------------------------|
# |1000 |TNDDR_RN |MCSE_bias          , 0.00937888917995188 |Bias               , -0.0502555279606786 |
# |-    |-        |MCSE_var           , 0.00318675781660534 |Var               , 0.0879635622498185   |
# |-    |-        |MCSE_mse          , 0.0030539040639501   |Mse               , 0.0904012167781752   |
# |-    |-        |%Cov , 0.899                             |Précision_var    , 0.476747976330855     |
...
# |n    |Methode   |Erreur de Monte Carlo                    |Autres                               |
# |:----|:---------|:----------------------------------------|:------------------------------------|
# |1000 |TNDDR_GLM |MCSE_bias         , 0.0128984689205921   |Bias             , -0.15139110014282 |
# |-    |-         |MCSE_var           , 0.00596637087410406 |Var              , 0.166370500495481 |
# |-    |-         |MCSE_mse           , 0.00272531200118626 |Mse              , 0.189123395197439 |
# |-    |-         |%Cov, 1                                  |Précision_var    , -13.5299545804351 |