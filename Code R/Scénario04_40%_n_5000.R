...
# |n    |Methode   |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:---------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_GLM |MCSE_bias         , 0.0023983470441664     |Bias              , 0.0830950283064633   |
# |-    |-         |MCSE_var            , 0.000288217921588453 |Var                , 0.00575206854426171 |
# |-    |-         |MCSE_mse            , 0.000549609040608603 |Mse               , 0.0126511002049694   |
# |-    |-         |%Cov , 0.828                               |Précision_var     , 0.0104060826880935   |
