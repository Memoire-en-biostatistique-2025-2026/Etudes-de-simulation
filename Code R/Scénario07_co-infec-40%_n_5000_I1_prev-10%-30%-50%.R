...
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |RegLog  |MCSE_bias          , 0.00282842286371003   |Bias             , 0.106673624839017     |
# |-    |-       |MCSE_var            , 0.000361427005168112 |Var                , 0.00799997589595763 |
# |-    |-       |MCSE_mse            , 0.000788459449743068 |Mse              , 0.019371238156357     |
# |-    |-       |%Cov , 0.603                               |Précision_var     , 0.0389681769237109   |
################################ IPW ###########################################
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |IPW     |MCSE_bias          , 0.00293351052730737   |Bias             , 0.084364454614073     |
# |-    |-       |MCSE_var            , 0.000384727281054385 |Var                , 0.00860548401382314 |
# |-    |-       |MCSE_mse            , 0.000788459449743068 |Mse              , 0.019371238156357     |
# |-    |-       |%Cov , 0.758                               |Précision_var     , 0.0293893608850529   |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00304763671440692   |Bias             , 0.078908263163963     |
# |-    |-        |MCSE_var            , 0.000424701860674803 |Var                , 0.00928808954300103 |
# |-    |-        |MCSE_mse            , 0.000732881519320134 |Mse               , 0.0155053154490113   |
# |-    |-        |%Cov , 0.811                               |Précision_var     , 0.0447567255088245   |
################################################################################
...
# |n    |Methode     |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:-----------|:----------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias          , 0.00717489540215354 |Bias               , -0.0607668379950811 |
# |-    |-           |MCSE_var           , 0.00178230702641056 |Var              , 0.051479124031844     |
# |-    |-           |MCSE_mse           , 0.00198548324900541 |Mse               , 0.0551202535077326   |
# |-    |-           |%Cov, 0.98                               |Précision_var    , -1.19530010301766     |
################################################################################
...
# |n    |Methode    |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:----------|:----------------------------------------|:--------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias          , 0.00606263665300098 |Bias              , 0.0333517351021474 |
# |-    |-          |MCSE_var          , 0.0020884847702837   |Var               , 0.0367555631863109 |
# |-    |-          |MCSE_mse           , 0.00207628138672388 |Mse               , 0.0378311458574484 |
# |-    |-          |%Cov , 0.891                             |Précision_var     , -0.195292253623931 |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:--------|:----------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias          , 0.00914113753200023 |Bias               , -0.0627418319342407 |
# |-    |-        |MCSE_var           , 0.00283570698491893 |Var               , 0.0835603953789433   |
# |-    |-        |MCSE_mse           , 0.00287109904067892 |Mse               , 0.0874133724580289   |
# |-    |-        |%Cov , 0.851                             |Précision_var   , 1.45238643308653       |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |RegLog  |MCSE_bias          , 0.00135343031182447   |Bias             , 0.124329140539258     |
# |-    |-       |MCSE_var            , 8.53780237057636e-05 |Var                , 0.00183177360896528 |
# |-    |-       |MCSE_mse            , 0.000360011432300193 |Mse               , 0.0172876770225868   |
# |-    |-       |%Cov , 0.052                               |Précision_var     , 0.0116810374864103   |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |IPW     |MCSE_bias          , 0.00134769955743275   |Bias             , 0.105189044293054     |
# |-    |-       |MCSE_var            , 8.35633877956705e-05 |Var                , 0.00181629409710442 |
# |-    |-       |MCSE_mse            , 0.000360011432300193 |Mse               , 0.0172876770225868   |
# |-    |-       |%Cov , 0.132                               |Précision_var     , 0.0154678825509317   |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00138332532942919   |Bias             , 0.103542262105581     |
# |-    |-        |MCSE_var            , 8.72682496278787e-05 |Var                , 0.00191358896704037 |
# |-    |-        |MCSE_mse            , 0.000312176207997333 |Mse               , 0.0126326754200141   |
# |-    |-        |%Cov , 0.221                               |Précision_var     , 0.0129435783352396   |
################################################################################
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias          , 0.00137805458260863   |Bias             , 0.110591641444496     |
# |-    |-           |MCSE_var            , 8.77359227395401e-05 |Var                , 0.00189903443264864 |
# |-    |-           |MCSE_mse            , 0.000330499701714867 |Mse              , 0.014127646555604     |
# |-    |-           |%Cov , 0.035                               |Précision_var     , 0.0435275832129529   |
################################################################################
...
# |n    |Methode    |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias          , 0.00241190399150946   |Bias             , 0.097294580291964     |
# |-    |-          |MCSE_var            , 0.000769060834437717 |Var                , 0.00581728086425926 |
# |-    |-          |MCSE_mse            , 0.000701179083525682 |Mse               , 0.0152776989375844   |
# |-    |-          |%Cov , 0.346                               |Précision_var   , 0.38768492267554       |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias          , 0.00308102233637824   |Bias              , 0.0844774715900821   |
# |-    |-        |MCSE_var           , 0.00124996043900186   |Var                , 0.00949269863726164 |
# |-    |-        |MCSE_mse            , 0.000860468852256721 |Mse               , 0.0166196491448775   |
# |-    |-        |%Cov , 0.325                               |Précision_var    , 0.836324539254684     |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |RegLog  |MCSE_bias          , 0.00132718061241299   |Bias             , 0.155235035991219     |
# |-    |-       |MCSE_var            , 8.36687836097353e-05 |Var                , 0.00176140837796493 |
# |-    |-       |MCSE_mse            , 0.000430093352253128 |Mse               , 0.0258575633687821   |
# |-    |-       |%Cov , 0.008                               |Précision_var      , 0.00918210720861067 |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |IPW     |MCSE_bias          , 0.00131900738487214   |Bias             , 0.136648303446157     |
# |-    |-       |MCSE_var            , 8.14420497380651e-05 |Var                , 0.00173978048134725 |
# |-    |-       |MCSE_mse            , 0.000430093352253128 |Mse               , 0.0258575633687821   |
# |-    |-       |%Cov , 0.016                               |Précision_var     , 0.0156709467419737   |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00138265356022046   |Bias             , 0.134853794492636     |
# |-    |-        |MCSE_var            , 9.15294450724376e-05 |Var                , 0.00191173086759032 |
# |-    |-        |MCSE_mse            , 0.000397347635808637 |Mse               , 0.0200953650257847   |
# |-    |-        |%Cov , 0.048                               |Précision_var     , 0.0116063553254991   |
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias          , 0.00134074532770232   |Bias             , 0.141210108892723     |
# |-    |-           |MCSE_var            , 8.36406044792515e-05 |Var                , 0.00179759803375561 |
# |-    |-           |MCSE_mse            , 0.000398173764137217 |Mse               , 0.0217360952892166   |
# |-    |-           |%Cov , 0.006                               |Précision_var     , 0.0332508991603645   |
...
# |n    |Methode    |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias         , 0.0023843378168519     |Bias             , 0.130695534479945     |
# |-    |-          |MCSE_var           , 0.00091467288915957   |Var                , 0.00568506682487009 |
# |-    |-          |MCSE_mse            , 0.000876337012132254 |Mse               , 0.0227607044910437   |
# |-    |-          |%Cov , 0.128                               |Précision_var    , 0.432681825999463     |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias          , 0.00250503223316419   |Bias             , 0.126681809809132     |
# |-    |-        |MCSE_var           , 0.00108960209910887   |Var                , 0.00627518648919158 |
# |-    |-        |MCSE_mse            , 0.000729525678480801 |Mse               , 0.0223171922392196   |
# |-    |-        |%Cov, 0.08                                 |Précision_var    , 0.639483087298042     |