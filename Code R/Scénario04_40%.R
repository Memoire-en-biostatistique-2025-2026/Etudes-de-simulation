...
# |n    |Methode     |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:-----------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_Lasso |MCSE_bias        , 0.011498797210813     |Bias              , -0.120433312309747 |
# |-    |-           |MCSE_var           , 0.00429653965085831 |Var              , 0.131693447946219   |
# |-    |-           |MCSE_mse           , 0.00296511748878102 |Mse              , 0.146065408322821   |
# |-    |-           |%Cov             , 0.993975903614458     |Précision_var   , 3.08609860119621     |
...
# |n    |Methode   |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:---------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_GLM |MCSE_bias         , 0.0111411517849698   |Bias              , -0.134858092697998 |
# |-    |-         |MCSE_var           , 0.00445699784091136 |Var              , 0.124125263095736   |
# |-    |-         |MCSE_mse           , 0.00300051532584752 |Mse              , 0.142187842998782   |
# |-    |-         |%Cov, 1                                  |Précision_var    , -5.13120342241828   |