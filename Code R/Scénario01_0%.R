...
# |:----|:-------|:------------------------------------------|:------------------------------------------|
# |1000 |RegLog  |MCSE_bias          , 0.00227444137374124   |Bias               , 0.00323537244356092   |
# |-    |-       |MCSE_var            , 0.000268444139433194 |Var                , 0.00517308356258592   |
# |-    |-       |MCSE_mse            , 0.000273132372342093 |Mse                , 0.00517837811387188   |
# |-    |-       |%Cov , 0.943                               |Précision_var       , 0.000365146948291067 |
################################ IPW ###########################################
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                     |
# |:----|:-------|:------------------------------------------|:------------------------------------------|
# |1000 |IPW     |MCSE_bias          , 0.00240096525038281   |Bias               , 0.00228620993845902   |
# |-    |-       |MCSE_var            , 0.000306395915174196 |Var                , 0.00576463413354578   |
# |-    |-       |MCSE_mse            , 0.000273132372342093 |Mse                , 0.00517837811387188   |
# |-    |-       |%Cov , 0.948                               |Précision_var       , 0.000283793088305923 |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                     |
# |:----|:--------|:------------------------------------------|:------------------------------------------|
# |1000 |TNDDR_RF |MCSE_bias          , 0.00245464340235937   |Bias               , -0.0140246034020362   |
# |-    |-        |MCSE_var            , 0.000312383823182818 |Var                , 0.00602527423274641   |
# |-    |-        |MCSE_mse            , 0.000303140116421317 |Mse                , 0.00621593845909806   |
# |-    |-        |%Cov , 0.922                               |Précision_var       , -0.00370040611605565 |
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                     |
# |:----|:-----------|:------------------------------------------|:------------------------------------------|
# |1000 |TNDDR_Lasso |MCSE_bias          , 0.00248092043340557   |Bias                , -0.00590702405252785 |
# |-    |-           |MCSE_var            , 0.000339751039896466 |Var                , 0.00615496619688926   |
# |-    |-           |MCSE_mse            , 0.000333430733649638 |Mse                , 0.00618370416384951   |
# |-    |-           |%Cov , 0.873                               |Précision_var     , 0.0428780322865198     |
...
# |n    |Methode    |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:----------|:----------------------------------------|:----------------------------------------|
# |1000 |TNDDR_Mars |MCSE_bias          , 0.00491370032837968 |Bias               , -0.0316660091731172 |
# |-    |-          |MCSE_var           , 0.00171971405016944 |Var               , 0.0241444509171186   |
# |-    |-          |MCSE_mse           , 0.00172871788908916 |Mse               , 0.0251230426031534   |
# |-    |-          |%Cov , 0.937                             |Précision_var    , 0.744980120399188     |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:--------|:----------------------------------------|:----------------------------------------|
# |1000 |TNDDR_RN |MCSE_bias          , 0.00613882575271782 |Bias               , -0.0551638042174377 |
# |-    |-        |MCSE_var          , 0.0021516982371116   |Var               , 0.0376851816222315   |
# |-    |-        |MCSE_mse           , 0.00225362494702716 |Mse               , 0.0406905417363491   |
# |-    |-        |%Cov , 0.891                             |Précision_var   , 1.14049951108562       |
...
# |n    |Methode   |Erreur de Monte Carlo                      |Autres                                     |
# |:----|:---------|:------------------------------------------|:------------------------------------------|
# |1000 |TNDDR_GLM |MCSE_bias          , 0.00250426452160365   |Bias                , -0.00310475270600491 |
# |-    |-         |MCSE_var           , 0.00032990692454687   |Var                , 0.00627134079416277   |
# |-    |-         |MCSE_mse            , 0.000325423082740869 |Mse                , 0.00627470894273405   |
# |-    |-         |%Cov , 0.939                               |Précision_var       , -0.00429155751558075 |
