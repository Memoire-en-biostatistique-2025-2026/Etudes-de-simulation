...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |1000 |TNDDR_Lasso |MCSE_bias          , 0.00305113992273177   |Bias             , 0.030974391170521     |
# |-    |-           |MCSE_var            , 0.000448806573982367 |Var                , 0.00930945482808764 |
# |-    |-           |MCSE_mse            , 0.000530753207801954 |Mse              , 0.010259558281644     |
# |-    |-           |%Cov , 0.868                               |Précision_var     , 0.0502757058257661   |
...
# |n    |Methode   |Erreur de Monte Carlo                      |Autres                                       |
# |:----|:---------|:------------------------------------------|:--------------------------------------------|
# |1000 |TNDDR_GLM |MCSE_bias          , 0.00311827320268677   |Bias              , 0.0398227319451136       |
# |-    |-         |MCSE_var            , 0.000517448113408838 |Var                , 0.00972362776659438     |
# |-    |-         |MCSE_mse            , 0.000629417232343063 |Mse               , 0.0112997541184002       |
# |-    |-         |%Cov , 0.969                               |Précision_var        , -0.000788324776633487 |