...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |1000 |TNDDR_Lasso |MCSE_bias          , 0.00251938414488111   |Bias              , 0.0207051329925525   |
# |-    |-           |MCSE_var            , 0.000319244128932419 |Var                , 0.00634729646947834 |
# |-    |-           |MCSE_mse            , 0.000362522070320802 |Mse                , 0.00676965170524814 |
# |-    |-           |%Cov, 0.72                                 |Précision_var     , 0.0809004964909286   |
...
# |n    |Methode   |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:---------|:----------------------------------------|:----------------------------------------|
# |1000 |TNDDR_GLM |MCSE_bias         , 0.0132443929235937   |Bias               , -0.0279120853471097 |
# |-    |-         |MCSE_var           , 0.00355989673153315 |Var              , 0.175413943914539     |
# |-    |-         |MCSE_mse           , 0.00320884802771863 |Mse              , 0.176017614479049     |
# |-    |-         |%Cov , 0.996                             |Précision_var    , -10.7933738547249     |
