...
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |RegLog  |MCSE_bias          , 0.00151156134315994   |Bias             , 0.145881274437721     |
# |-    |-       |MCSE_var           , 0.00010249629826248   |Var               , 0.0022848176941355   |
# |-    |-       |MCSE_mse            , 0.000466120298141958 |Mse              , 0.023563879108015     |
# |-    |-       |%Cov , 0.041                               |Précision_var      , 0.00763077588000295 |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |IPW     |MCSE_bias          , 0.00150312321628457   |Bias             , 0.116955822605148     |
# |-    |-       |MCSE_var            , 0.000102627381400631 |Var                , 0.00225937940333367 |
# |-    |-       |MCSE_mse            , 0.000466120298141958 |Mse              , 0.023563879108015     |
# |-    |-       |%Cov , 0.176                               |Précision_var     , 0.0072413381091032   |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00153430225673639   |Bias             , 0.108765023238483     |
# |-    |-        |MCSE_var            , 0.000109869812479076 |Var                , 0.00235408341502637 |
# |-    |-        |MCSE_mse           , 0.00036183044118092   |Mse               , 0.0141815596116792   |
# |-    |-        |%Cov , 0.305                               |Précision_var      , 0.00785718567128146 |
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias          , 0.00150283053126624   |Bias             , 0.114535990891161     |
# |-    |-           |MCSE_var           , 0.00010260085409124   |Var                , 0.00225849960570598 |
# |-    |-           |MCSE_mse            , 0.000372147199207345 |Mse               , 0.0153747343155203   |
# |-    |-           |%Cov , 0.102                               |Précision_var     , 0.0290280878362156   |
...
# |n    |Methode    |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias          , 0.00267765096580702   |Bias             , 0.104338010564139     |
# |-    |-          |MCSE_var            , 0.000927993892258543 |Var                , 0.00716981469468728 |
# |-    |-          |MCSE_mse           , 0.00083463830424217   |Mse              , 0.018049065328475     |
# |-    |-          |%Cov , 0.424                               |Précision_var    , 0.481979901237788     |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:--------|:----------------------------------------|:--------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias          , 0.00384988018043176 |Bias              , 0.0847248344108883 |
# |-    |-        |MCSE_var          , 0.0015497585325868   |Var               , 0.0148215774036813 |
# |-    |-        |MCSE_mse           , 0.00114042548708336 |Mse             , 0.02198505339223     |
# |-    |-        |%Cov , 0.431                             |Précision_var    , 0.963189630803507   |
...
# |n    |Methode   |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:---------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_GLM |MCSE_bias         , 0.0015147985505313     |Bias             , 0.114549286814475     |
# |-    |-         |MCSE_var            , 0.000103781316761213 |Var                , 0.00229461464869174 |
# |-    |-         |MCSE_mse            , 0.000375454078854381 |Mse               , 0.0154138591437478   |
# |-    |-         |%Cov , 0.254                               |Précision_var      , 0.00671035064098076 |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |RegLog  |MCSE_bias          , 0.00147862397675526   |Bias             , 0.174233438821346     |
# |-    |-       |MCSE_var            , 0.000100398119634841 |Var                , 0.00218632886463553 |
# |-    |-       |MCSE_mse            , 0.000543558578418182 |Mse               , 0.0325414337392825   |
# |-    |-       |%Cov , 0.004                               |Précision_var      , 0.00845884990760126 |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |IPW     |MCSE_bias        , 0.001478645325828       |Bias             , 0.148016513258223     |
# |-    |-       |MCSE_var            , 9.86893227252025e-05 |Var              , 0.002186391999593     |
# |-    |-       |MCSE_mse            , 0.000543558578418182 |Mse               , 0.0325414337392825   |
# |-    |-       |%Cov , 0.028                               |Précision_var      , 0.00904126284520432 |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00151595614702113   |Bias             , 0.140520083188211     |
# |-    |-        |MCSE_var            , 0.000108134861424387 |Var                , 0.00229812303969116 |
# |-    |-        |MCSE_mse            , 0.000462603878126656 |Mse               , 0.0220417186958732   |
# |-    |-        |%Cov , 0.079                               |Précision_var      , 0.00919272728555146 |    |-        |%Cov , 0.079                               |Précision_var      , 0.00919272728555146 |
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias          , 0.00147283838192905   |Bias             , 0.146445121730789     |
# |-    |-           |MCSE_var           , 9.8520075975014e-05   |Var                , 0.00216925289928338 |
# |-    |-           |MCSE_mse            , 0.000460473097096515 |Mse               , 0.0236132573251296   |
# |-    |-           |%Cov , 0.011                               |Précision_var     , 0.0257938129425137   |
...
# |n    |Methode    |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias         , 0.0027141878374993     |Bias             , 0.134840752006014     |
# |-    |-          |MCSE_var           , 0.00104150125634861   |Var                , 0.00736681561722915 |
# |-    |-          |MCSE_mse            , 0.000851137308146248 |Mse               , 0.0255414772031593   |
# |-    |-          |%Cov , 0.163                               |Précision_var    , 0.534334430106554     |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                 |
# |:----|:--------|:------------------------------------------|:--------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias          , 0.00330214482808055   |Bias             , 0.122741129614706   |
# |-    |-        |MCSE_var          , 0.0014395232232837     |Var               , 0.0109041604656191 |
# |-    |-        |MCSE_mse            , 0.000895417608083333 |Mse               , 0.0259586412042476 |
# |-    |-        |%Cov , 0.164                               |Précision_var    , 0.825610609985326   |
...
# |n    |Methode   |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:---------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_GLM |MCSE_bias          , 0.00147667069667727   |Bias             , 0.146267817171159     |
# |-    |-         |MCSE_var            , 9.79208548403374e-05 |Var                , 0.00218055634642534 |
# |-    |-         |MCSE_mse            , 0.000460084336841359 |Mse               , 0.0235726501300945   |
# |-    |-         |%Cov , 0.056                               |Précision_var      , 0.00818042617505853 |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |RegLog  |MCSE_bias          , 0.00142068512301039   |Bias             , 0.200625356415004     |
# |-    |-       |MCSE_var            , 9.56543876528701e-05 |Var                , 0.00201834621874304 |
# |-    |-       |MCSE_mse            , 0.000588266742964236 |Mse               , 0.0422668615091716   |
# |-    |-       |%Cov, 0                                    |Précision_var      , 0.00537560794693473 |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |IPW     |MCSE_bias          , 0.00141490254580944   |Bias            , 0.17512331753281       |
# |-    |-       |MCSE_var           , 9.3826657534955e-05   |Var                , 0.00200194921413803 |
# |-    |-       |MCSE_mse            , 0.000588266742964236 |Mse               , 0.0422668615091716   |
# |-    |-       |%Cov , 0.005                               |Précision_var      , 0.00564252654529719 |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00144876907116348   |Bias             , 0.168393236011517     |
# |-    |-        |MCSE_var            , 9.47630990219553e-05 |Var                , 0.00209893182155988 |
# |-    |-        |MCSE_mse            , 0.000507330302557552 |Mse               , 0.0304531148241687   |
# |-    |-        |%Cov , 0.015                               |Précision_var      , 0.00542367269737323 |
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias          , 0.00142250176227682   |Bias             , 0.173616242965269     |
# |-    |-           |MCSE_var            , 9.40759457125619e-05 |Var                , 0.00202351126368066 |
# |-    |-           |MCSE_mse            , 0.000514205037952461 |Mse               , 0.0321640875737925   |
# |-    |-           |%Cov , 0.001                               |Précision_var     , 0.0211143539339649   |
...
# |n    |Methode    |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias          , 0.00240021968883203   |Bias             , 0.166095382949617     |
# |-    |-          |MCSE_var            , 0.000919552221026024 |Var                , 0.00576105455465694 |
# |-    |-          |MCSE_mse            , 0.000800657525459716 |Mse               , 0.0333429697372821   |
# |-    |-          |%Cov , 0.073                               |Précision_var    , 0.339828902615015     |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias          , 0.00269372615118638   |Bias             , 0.160689213217268     |
# |-    |-        |MCSE_var           , 0.00121707485132387   |Var                , 0.00725616057758537 |
# |-    |-        |MCSE_mse            , 0.000753263457426119 |Mse               , 0.0330699276613923   |
# |-    |-        |%Cov, 0.06                                 |Précision_var    , 0.604429852020927     |
...
# |n    |Methode   |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:---------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_GLM |MCSE_bias          , 0.00141213926171265   |Bias             , 0.173845250443173     |
# |-    |-         |MCSE_var            , 9.32701902168401e-05 |Var                , 0.00199413729447035 |
# |-    |-         |MCSE_mse         , 0.000509684150242       |Mse               , 0.0322143142588254   |
# |-    |-         |%Cov , 0.007                               |Précision_var      , 0.00495085686104869 |