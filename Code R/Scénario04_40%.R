...
sum(rowSums(is.na(resultats3[,10:18])) > 0) # 5
...
# |:----|:-------|:----------------------------------------|:--------------------------------------|
# |1000 |RegLog  |MCSE_bias          , 0.00573705495982509 |Bias             , 0.131915156928142   |
# |-    |-       |MCSE_var           , 0.00292694932788833 |Var               , 0.0329137996120536 |
# |-    |-       |MCSE_mse           , 0.00399417048340376 |Mse               , 0.0502824944398178 |
# |-    |-       |%Cov , 0.881                             |Précision_var     , 0.0206480537165434 |
...
# |n    |Methode |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:-------|:----------------------------------------|:--------------------------------------|
# |1000 |IPW     |MCSE_bias          , 0.00656427215159042 |Bias             , 0.126417359833224   |
# |-    |-       |MCSE_var           , 0.00461862960970596 |Var               , 0.0430896688801455 |
# |-    |-       |MCSE_mse           , 0.00399417048340376 |Mse               , 0.0502824944398178 |
# |-    |-       |%Cov , 0.906                             |Précision_var     , 0.0260629751607648 |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:--------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_RF |MCSE_bias          , 0.00701923920278166 |Bias             , 0.045234492858043   |
# |-    |-        |MCSE_var           , 0.00233632376274867 |Var               , 0.0492697189858669 |
# |-    |-        |MCSE_mse           , 0.00244930157311534 |Mse               , 0.0512666086110054 |
# |-    |-        |%Cov , 0.982                             |Précision_var    , 0.501993259995199   |
...
# |n    |Methode     |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:-----------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_Lasso |MCSE_bias         , 0.0112813168162103   |Bias              , -0.115187980468752 |
# |-    |-           |MCSE_var           , 0.00418475711659993 |Var              , 0.126631768562171   |
# |-    |-           |MCSE_mse           , 0.00301432290831426 |Mse              , 0.139772771297533   |
# |-    |-           |%Cov             , 0.998994974874372     |Précision_var   , 3.05339043004987     |
...
# |n    |Methode    |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:----------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_Mars |MCSE_bias          , 0.00945077703138507 |Bias              , 0.0248930813381915 |
# |-    |-          |MCSE_var           , 0.00308418390692681 |Var               , 0.0893171864969557 |
# |-    |-          |MCSE_mse           , 0.00319325308547334 |Mse               , 0.0898475348089685 |
# |-    |-          |%Cov , 0.966                             |Précision_var    , 0.218589765277325   |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:--------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_RN |MCSE_bias         , 0.0129699756141576   |Bias              , -0.127787198226699 |
# |-    |-        |MCSE_var           , 0.00528279279098046 |Var              , 0.168220267431843   |
# |-    |-        |MCSE_mse           , 0.00285103714455353 |Mse              , 0.184381615195041   |
# |-    |-        |%Cov , 0.828                             |Précision_var    , -9.07290713980523   |
...
# |n    |Methode   |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:---------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_GLM |MCSE_bias         , 0.0103310664773586   |Bias              , -0.171884208178814 |
# |-    |-         |MCSE_var           , 0.00459319735273248 |Var              , 0.106730934559602   |
# |-    |-         |MCSE_mse          , 0.0029030594845211   |Mse            , 0.1361683846463       |
# |-    |-         |%Cov, 1                                  |Précision_var    , -5.90947350829793   |