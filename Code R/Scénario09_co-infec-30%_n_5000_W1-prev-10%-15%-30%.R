...
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |RegLog  |MCSE_bias          , 0.00168099979115531   |Bias             , 0.165179660374365     |
# |-    |-       |MCSE_var            , 0.000143288559936907 |Var                , 0.00282576029786419 |
# |-    |-       |MCSE_mse           , 0.00060694193173658   |Mse               , 0.0301072547389569   |
# |-    |-       |%Cov , 0.016                               |Précision_var     , 0.0177207992444735   |
################################ IPW ###########################################
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |IPW     |MCSE_bias          , 0.00163863841152313   |Bias             , 0.142443047454319     |
# |-    |-       |MCSE_var            , 0.000136927810133721 |Var                , 0.00268513584371904 |
# |-    |-       |MCSE_mse           , 0.00060694193173658   |Mse               , 0.0301072547389569   |
# |-    |-       |%Cov , 0.066                               |Précision_var     , 0.0167132092487773   |
########################## TNDDR ###############################
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00169301974292134   |Bias            , 0.13912192754701       |
# |-    |-        |MCSE_var            , 0.000146413540215623 |Var                , 0.00286631584992144 |
# |-    |-        |MCSE_mse            , 0.000528647004554697 |Mse               , 0.0222183602584669   |
# |-    |-        |%Cov , 0.121                               |Précision_var     , 0.0167844280214891   |
################################################################################
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias          , 0.00313027535652761   |Bias             , 0.153126261887726     |
# |-    |-           |MCSE_var            , 0.000468249980207897 |Var                , 0.00979862380768406 |
# |-    |-           |MCSE_mse            , 0.000960681977131679 |Mse               , 0.0332364772635847   |
# |-    |-           |%Cov , 0.465                               |Précision_var     , 0.0404444085787871   |
################################################################################
...
# |n    |Methode    |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:----------|:----------------------------------------|:--------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias         , 0.0034591664552093   |Bias             , 0.128972639384344   |
# |-    |-          |MCSE_var         , 0.001337751559868     |Var               , 0.0119658325648453 |
# |-    |-          |MCSE_mse           , 0.00122015453468501 |Mse               , 0.0285878084420444 |
# |-    |-          |%Cov , 0.283                             |Précision_var    , 0.563806166034017   |
################################################################################
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:--------|:----------------------------------------|:--------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias          , 0.00542308938279596 |Bias              , 0.0841313562345644 |
# |-    |-        |MCSE_var           , 0.00211551800429257 |Var               , 0.0294098984537943 |
# |-    |-        |MCSE_mse           , 0.00154195707086997 |Mse               , 0.0364585736572077 |
# |-    |-        |%Cov , 0.355                             |Précision_var  , 1.3487946440389       |
################################################################################
################################################################################
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |RegLog  |MCSE_bias          , 0.00153363872621429   |Bias             , 0.196272852751467     |
# |-    |-       |MCSE_var            , 0.000108312526148459 |Var                , 0.00235204774254418 |
# |-    |-       |MCSE_mse            , 0.000628426582974736 |Mse               , 0.0408727284220008   |
# |-    |-       |%Cov , 0.001                               |Précision_var     , 0.0119191357740873   |
################################ IPW ###########################################
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |IPW     |MCSE_bias          , 0.00153431570544649   |Bias             , 0.176015118415779     |
# |-    |-       |MCSE_var            , 0.000108707692457851 |Var                , 0.00235412468397975 |
# |-    |-       |MCSE_mse            , 0.000628426582974736 |Mse               , 0.0408727284220008   |
# |-    |-       |%Cov , 0.006                               |Précision_var     , 0.0162077255678053   |
########################## TNDDR ###############################
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00159693145737049   |Bias            , 0.17307294777928       |
# |-    |-        |MCSE_var            , 0.000120161016121398 |Var                , 0.00255019007953944 |
# |-    |-        |MCSE_mse            , 0.000591792073657037 |Mse               , 0.0325018851424692   |
# |-    |-        |%Cov , 0.017                               |Précision_var     , 0.0132918507089151   |
################################################################################
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias          , 0.00163035265615836   |Bias             , 0.182886261414897     |
# |-    |-           |MCSE_var            , 0.000135599975016299 |Var                , 0.00265804978344263 |
# |-    |-           |MCSE_mse            , 0.000606431789587747 |Mse              , 0.036102776347977     |
# |-    |-           |%Cov , 0.048                               |Précision_var     , 0.0388477114718815   |
...
# |n    |Methode    |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias         , 0.0027920584082204     |Bias             , 0.164152124944987     |
# |-    |-          |MCSE_var            , 0.000977770928994687 |Var                , 0.00779559015491422 |
# |-    |-          |MCSE_mse            , 0.000957071960248226 |Mse               , 0.0347337146887138   |
# |-    |-          |%Cov , 0.116                               |Précision_var    , 0.350179353478576     |
################################################################################
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                               |
# |:----|:--------|:----------------------------------------|:------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias          , 0.00429530646658629 |Bias             , 0.150737755370414 |
# |-    |-        |MCSE_var           , 0.00196259559607531 |Var              , 0.018449657641898 |
# |-    |-        |MCSE_mse           , 0.00146639054513799 |Mse              , 0.041153078878367 |
# |-    |-        |%Cov , 0.134                             |Précision_var    , 0.864217254207267 |
################################################################################
################################################################################
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |RegLog  |MCSE_bias          , 0.00159359466393121   |Bias             , 0.234877793407975     |
# |-    |-       |MCSE_var            , 0.000118826755152027 |Var                , 0.00253954395291001 |
# |-    |-       |MCSE_mse            , 0.000777638522564099 |Mse               , 0.0577045822451564   |
# |-    |-       |%Cov, 0                                    |Précision_var     , 0.0134101440356874   |
################################ IPW ###########################################
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |IPW     |MCSE_bias          , 0.00157743660131173   |Bias             , 0.216378511934917     |
# |-    |-       |MCSE_var            , 0.000114730906468731 |Var                , 0.00248830623115789 |
# |-    |-       |MCSE_mse            , 0.000777638522564099 |Mse               , 0.0577045822451564   |
# |-    |-       |%Cov, 0                                    |Précision_var     , 0.0179464566208088   |
########################## TNDDR ###############################
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00161364758421499   |Bias            , 0.21244977417758       |
# |-    |-        |MCSE_var            , 0.000116841632157697 |Var                , 0.00260385852604288 |
# |-    |-        |MCSE_mse            , 0.000710729264329064 |Mse               , 0.0477361612156218   |
# |-    |-        |%Cov, 0                                    |Précision_var     , 0.0129443619646356   |
################################################################################
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias          , 0.00160934369534345   |Bias            , 0.22139179082562       |
# |-    |-           |MCSE_var            , 0.000120957540605731 |Var                , 0.00258998712974172 |
# |-    |-           |MCSE_mse           , 0.00073645022241317   |Mse               , 0.0516017221875871   |
# |-    |-           |%Cov , 0.004                               |Précision_var     , 0.0417855853198331   |
...
# |n    |Methode    |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:----------|:----------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias          , 0.00274904495891315 |Bias             , 0.206238900631201     |
# |-    |-          |MCSE_var           , 0.00112011806690124 |Var                , 0.00755724818612579 |
# |-    |-          |MCSE_mse           , 0.00108316674236298 |Mse              , 0.050084175071506     |
# |-    |-          |%Cov , 0.058                             |Précision_var    , 0.458534613959005     |
################################################################################
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:--------|:----------------------------------------|:--------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias         , 0.0036287218628526   |Bias             , 0.193742774410024   |
# |-    |-        |MCSE_var           , 0.00169986553140818 |Var               , 0.0131676223579444 |
# |-    |-        |MCSE_mse           , 0.00109286893332728 |Mse               , 0.0506907173716801 |
# |-    |-        |%Cov , 0.075                             |Précision_var    , 0.741852846879047   |