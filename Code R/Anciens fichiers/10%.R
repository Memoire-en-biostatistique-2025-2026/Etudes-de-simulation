...
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |1000 |RegLog  |MCSE_bias          , 0.00334452093751611   |Bias              , 0.0373644143864391   |
# |-    |-       |MCSE_var            , 0.000394228985300949 |Var                , 0.00559291015074183 |
# |-    |-       |MCSE_mse            , 0.000543611519102315 |Mse                , 0.00697782379288188 |
# |-    |-       |%Cov , 0.922                               |Précision_var      , 0.00264178874198082 |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |1000 |IPW     |MCSE_bias          , 0.00338278255986661   |Bias              , 0.0309898514294878   |
# |-    |-       |MCSE_var            , 0.000368725061832734 |Var                , 0.00572160892366885 |
# |-    |-       |MCSE_mse            , 0.000543611519102315 |Mse                , 0.00697782379288188 |
# |-    |-       |%Cov , 0.914                               |Précision_var      , 0.00508430492864134 |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                     |
# |:----|:--------|:------------------------------------------|:------------------------------------------|
# |1000 |TNDDR_RF |MCSE_bias          , 0.00357282232538754   |Bias              , 0.0207040463208845     |
# |-    |-        |MCSE_var            , 0.000419026958767835 |Var                , 0.00638252968439381   |
# |-    |-        |MCSE_mse            , 0.000495765206196024 |Mse                , 0.00679842215908235   |
# |-    |-        |%Cov , 0.966                               |Précision_var       , -0.00128220197046136 |
...
# |n    |Methode     |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:-----------|:----------------------------------------|:--------------------------------------|
# |1000 |TNDDR_Lasso |MCSE_bias          , 0.00517928126626542 |Bias              , 0.0531556326090115 |
# |-    |-           |MCSE_var           , 0.00192535129944467 |Var              , 0.013412477217544   |
# |-    |-           |MCSE_mse           , 0.00222154924271323 |Mse               , 0.0162111735411731 |
# |-    |-           |%Cov , 0.662                             |Précision_var    , 0.462249429978456   |
...
# |n    |Methode    |Erreur de Monte Carlo                    |Autres                                     |
# |:----|:----------|:----------------------------------------|:------------------------------------------|
# |1000 |TNDDR_Mars |MCSE_bias          , 0.00834512405784326 |Bias                , -0.00419218239229924 |
# |-    |-          |MCSE_var           , 0.00311448935432387 |Var               , 0.0348205477703971     |
# |-    |-          |MCSE_mse          , 0.0031143350965494   |Mse               , 0.0347684810680666     |
# |-    |-          |%Cov , 0.956                             |Précision_var    , 0.889117945664688       |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:--------|:----------------------------------------|:----------------------------------------|
# |1000 |TNDDR_RN |MCSE_bias         , 0.0101643817442485   |Bias               , -0.0343625336177241 |
# |-    |-        |MCSE_var          , 0.0036530719544421   |Var               , 0.0516573281214062   |
# |-    |-        |MCSE_mse           , 0.00363456328033651 |Mse               , 0.0527347971817926   |
# |-    |-        |%Cov , 0.926                             |Précision_var   , 1.49881349459936       |
