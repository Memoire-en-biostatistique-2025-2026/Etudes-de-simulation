...
df$Biais <- c(Tab01_1$Autres[[1]]$value, Tab01_2$Autres[[1]]$value, Tab01_3$Autres[[1]]$value, Tab01_4$Autres[[1]]$value,
              Tab01_5_1$Autres[[1]]$value, Tab01_5_2$Autres[[1]]$value, Tab01_5_3$Autres[[1]]$value,
              Tab01_6_1$Autres[[1]]$value, Tab01_6_2$Autres[[1]]$value, Tab01_6_3$Autres[[1]]$value,
              Tab01_7_1$Autres[[1]]$value, Tab01_7_2$Autres[[1]]$value, Tab01_7_3$Autres[[1]]$value,
              Tab01_8_1$Autres[[1]]$value, Tab01_8_2$Autres[[1]]$value, NA,
              Tab01_9_1$Autres[[1]]$value, Tab01_9_2$Autres[[1]]$value, Tab01_9_3$Autres[[1]]$value,
              
              Tab01_1_5000$Autres[[1]]$value, Tab01_2_5000$Autres[[1]]$value, Tab01_3_5000$Autres[[1]]$value, Tab01_4_5000$Autres[[1]]$value,
              Tab01_5_1_5000$Autres[[1]]$value, Tab01_5_2_5000$Autres[[1]]$value, Tab01_5_3_5000$Autres[[1]]$value,
              Tab01_6_1_5000$Autres[[1]]$value, Tab01_6_2_5000$Autres[[1]]$value, Tab01_6_3_5000$Autres[[1]]$value,
              Tab01_7_1_5000$Autres[[1]]$value, Tab01_7_2_5000$Autres[[1]]$value, Tab01_7_3_5000$Autres[[1]]$value,
              Tab01_8_1_5000$Autres[[1]]$value, Tab01_8_2_5000$Autres[[1]]$value, Tab01_8_3_5000$Autres[[1]]$value,
              Tab01_9_1_5000$Autres[[1]]$value, Tab01_9_2_5000$Autres[[1]]$value, Tab01_9_3_5000$Autres[[1]]$value)

df$Taille <- c(rep(1000, 19), rep(5000, 19))

df$TCI_TND <- c(0, 0.1, 0.2, 0.4, rep(0.3, 15), 0, 0.1, 0.2, 0.4, rep(0.3, 15))


df$TCI_POP <- c(0, 0.02, 0.05, 0.11, 0.03, 0.04, 0.05, 0.07, 0.1, 0.14, rep(0.07, 3), 0.08, 0.07, 0.05
                , 0.07, 0.06, 0.06, 0, 0.02, 0.05, 0.11, 0.03, 0.04, 0.05, 0.07, 0.1, 0.14, rep(0.07, 3), 0.08, 0.07, 0.05
                , 0.07, 0.06, 0.06)

df$I2 <- c(rep(0.5, 4), 0.1, 0.15, 0.3, rep(0.5, 12), rep(0.5, 4), 0.1, 0.15, 0.3, rep(0.5, 12))

df$I1 <- c(rep(0.15, 7), 0.1, 0.3, 0.5, rep(0.15, 9), rep(0.15, 7), 0.1, 0.3, 0.5, rep(0.15, 9))

df$CV <- c(rep(0.35, 10), 0.5, 0.7, 0.85, rep(0.35, 6), rep(0.35, 10), 0.5, 0.7, 0.85, rep(0.35, 6))

df$W2 <- c(rep(0.02, 13), 0.05, 0.1, 0.2, rep(0.5, 3), rep(0.02, 13), 0.05, 0.1, 0.2, rep(0.5, 3))

df$W1 <- c(rep(0.05, 16), 0.1, 0.15, 0.2, rep(0.05, 16), 0.1, 0.15, 0.2)

df$Biais <- sapply(df$Biais, FUN = function(x)x[[1]])

View(df)

# Définition du modèle de régression

modele <- lm(Biais ~ Taille + TCI_TND + TCI_POP + I2 + I1 + CV + W1 +W2, data = df)
summary(modele)
