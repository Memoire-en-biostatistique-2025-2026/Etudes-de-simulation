...
################################################################################
# Scénario 08 (co-infection ~ 30% dans l'échantillon): Sous-scénario 01 : W2_prev = 5%, 10% et 20% 
#                                                                         
# Pour W2_prev = 5% : co_inf_para1 = 1, co_inf_para2 = 3
# Pour W2_prev = 10% : 
# Pour W2_prev = 20% : co_inf_para1 = 1, co_inf_para2 = 3
...
for (i in 1:nsim) {
  ...
  dat <- datagen(seed = seeds_list[i], ssize = 5000, W2_prev = 0.05,
                 co_inf_para1 = 0.5, co_inf_para2 = 3)
...
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |RegLog  |MCSE_bias          , 0.00254908374680025   |Bias              , 0.0532728615559698   |
# |-    |-       |MCSE_var            , 0.000306349687535916 |Var               , 0.0064978279482012   |
# |-    |-       |MCSE_mse            , 0.000464462781854561 |Mse                , 0.00932932789861453 |
# |-    |-       |%Cov, 0.9                                  |Précision_var      , 0.00668109204545309 |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |IPW     |MCSE_bias          , 0.00275848023051503   |Bias              , 0.0398453343557456   |
# |-    |-       |MCSE_var            , 0.000368717978476041 |Var                , 0.00760921318214224 |
# |-    |-       |MCSE_mse            , 0.000485655658023586 |Mse                , 0.00918925463888126 |
# |-    |-       |%Cov, 0.92                                 |Précision_var      , 0.00653977315068011 |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                     |
# |:----|:--------|:------------------------------------------|:------------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00284377125754471   |Bias              , 0.0213527545071114     |
# |-    |-        |MCSE_var            , 0.000421218062483737 |Var                , 0.00808703496523744   |
# |-    |-        |MCSE_mse            , 0.000478922659966795 |Mse                , 0.00853488805531316   |
# |-    |-        |%Cov , 0.957                               |Précision_var       , -0.00400375255299681 |
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias          , 0.00277947583297062   |Bias              , 0.0230762707270138   |
# |-    |-           |MCSE_var           , 0.00037147441003852   |Var                , 0.00772548590606775 |
# |-    |-           |MCSE_mse            , 0.000417771101454898 |Mse                , 0.00825027469082812 |
# |-    |-           |%Cov , 0.832                               |Précision_var    , 0.053986431297693     |
...
# |n    |Methode    |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:----------|:----------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias          , 0.00519372153153184 |Bias               , -0.0103188165764484 |
# |-    |-          |MCSE_var           , 0.00180268368240058 |Var               , 0.0269747433470975   |
# |-    |-          |MCSE_mse           , 0.00182465068260249 |Mse               , 0.0270542465792887   |
# |-    |-          |%Cov , 0.954                             |Précision_var    , 0.730582768246481     |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:--------|:----------------------------------------|:--------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias          , 0.00880987467357177 |Bias              , -0.148619193984919 |
# |-    |-        |MCSE_var           , 0.00254232244768635 |Var               , 0.0776138917640413 |
# |-    |-        |MCSE_mse           , 0.00337032441253474 |Mse               , 0.0996239426930041 |
# |-    |-        |%Cov , 0.894                             |Précision_var   , 1.21310510340054     |
...
# |n    |Methode   |Erreur de Monte Carlo                      |Autres                                     |
# |:----|:---------|:------------------------------------------|:------------------------------------------|
# |5000 |TNDDR_GLM |MCSE_bias          , 0.00278238437108291   |Bias              , 0.0297679051543692     |
# |-    |-         |MCSE_var            , 0.000399974002288461 |Var                , 0.00774166278844644   |
# |-    |-         |MCSE_mse            , 0.000479994853507684 |Mse                , 0.00862004930293752   |
# |-    |-         |%Cov , 0.959                               |Précision_var       , -0.00390672841607115 |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |RegLog  |MCSE_bias          , 0.00358176075146148   |Bias              , 0.0230992166746861   |
# |-    |-       |MCSE_var            , 0.000638110468034975 |Var               , 0.0128290100807099   |
# |-    |-       |MCSE_mse            , 0.000710105828434505 |Mse               , 0.0133497548816133   |
# |-    |-       |%Cov , 0.947                               |Précision_var      , 0.00207049559029654 |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |5000 |IPW     |MCSE_bias          , 0.00402002656231714   |Bias              , 0.0229972999230643   |
# |-    |-       |MCSE_var          , 0.0007968948692942     |Var               , 0.0161606135617354   |
# |-    |-       |MCSE_mse            , 0.000710105828434505 |Mse               , 0.0133497548816133   |
# |-    |-       |%Cov , 0.951                               |Précision_var      , 0.00186381202871522 |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                     |
# |:----|:--------|:----------------------------------------|:------------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00428470301906619 |Bias                , -0.00377829132416385 |
# |-    |-        |MCSE_var           , 0.00104231570694179 |Var               , 0.0183586799615949     |
# |-    |-        |MCSE_mse          , 0.0010422637273182   |Mse               , 0.0183545967669635     |
# |-    |-        |%Cov , 0.958                             |Précision_var    , 0.192422433974078       |
...
# |n    |Methode     |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:-----------|:----------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias          , 0.00442710580722977 |Bias               , -0.0220264424457087 |
# |-    |-           |MCSE_var           , 0.00110117405720966 |Var               , 0.0195992658284075   |
# |-    |-           |MCSE_mse           , 0.00112071034896071 |Mse               , 0.0200648307293932   |
# |-    |-           |%Cov , 0.841                             |Précision_var     , -0.103915987869625   |
...
# |n    |Methode    |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:----------|:----------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias          , 0.00692486204498668 |Bias               , -0.0452351729290361 |
# |-    |-          |MCSE_var           , 0.00239614003170716 |Var               , 0.0479537143420971   |
# |-    |-          |MCSE_mse           , 0.00261278225723432 |Mse               , 0.0499519814976748   |
# |-    |-          |%Cov , 0.935                             |Précision_var    , 0.574164782182664     |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:--------|:----------------------------------------|:--------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias         , 0.0109171180852833   |Bias              , -0.280925968117823 |
# |-    |-        |MCSE_var           , 0.00410620373416304 |Var             , 0.11918346728802     |
# |-    |-        |MCSE_mse           , 0.00446713717368657 |Mse              , 0.197983683383668   |
# |-    |-        |%Cov , 0.898                             |Précision_var    , -308.973468611524   |
...
# |n    |Methode   |Erreur de Monte Carlo                    |Autres                                     |
# |:----|:---------|:----------------------------------------|:------------------------------------------|
# |5000 |TNDDR_GLM |MCSE_bias          , 0.00459404063933205 |Bias                , -0.00691331407263751 |
# |-    |-         |MCSE_var           , 0.00125362215013039 |Var               , 0.0211052093958345     |
# |-    |-         |MCSE_mse          , 0.0012608980378206   |Mse               , 0.0211318980979056     |
# |-    |-         |%Cov , 0.948                             |Précision_var    , 0.315497818458688       |

################################################################################
################################################################################
# Pour I2_prev = 20% : co_inf_para1 = 1, co_inf_para2 = 3
# Proportion de co-infection ~30%
...
for (i in 1:nsim) {
  ...
  dat <- datagen(seed = seeds_list[i], ssize = 5000, W2_prev = 0.2,
                 co_inf_para1 = 1, co_inf_para2 = 3)
...
sum(rowSums(is.na(resultats3[,1:9])) > 0) # 1
sum(rowSums(is.na(resultats3[,10:18])) > 0) # 101
sum(rowSums(is.na(resultats3[,19:27])) > 0) 
sum(rowSums(is.na(resultats3[,28:36])) > 0)
sum(rowSums(is.na(resultats3[,37:45])) > 0) 
...
# |n    |Methode |Erreur de Monte Carlo                  |Autres                                 |
# |:----|:-------|:--------------------------------------|:--------------------------------------|
# |5000 |RegLog  |MCSE_bias         , 0.0100255863491147 |Bias              , 0.0444204569265503 |
# |-    |-       |MCSE_var          , 0.0147374187254841 |Var              , 0.100512381643556   |
# |-    |-       |MCSE_mse          , 0.0152942205960165 |Mse              , 0.102385046255476   |
# |-    |-       |%Cov , 0.931                           |Précision_var     , 0.0225320444180628 |
...
summary(resultats2$RRm)
resultats2 <- resultats2[resultats2$RRm < 1,] # 802
summary(resultats2$RRm)
...
# |n    |Methode |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:-------|:----------------------------------------|:----------------------------------------|
# |5000 |IPW     |MCSE_bias          , 0.00627535934947815 |Bias               , -0.0702012354775019 |
# |-    |-       |MCSE_var           , 0.00123760551050827 |Var               , 0.0315828682419964   |
# |-    |-       |MCSE_mse          , 0.0152942205960165   |Mse              , 0.102385046255476     |
# |-    |-       |%Cov             , 0.946384039900249     |Précision_var      , -0.0755877188680842 |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:--------|:----------------------------------------|:----------------------------------------|
# |5000 |TNDDR_RF |MCSE_bias          , 0.00697354241954012 |Bias               , -0.0307327052266296 |
# |-    |-        |MCSE_var           , 0.00167874213283844 |Var               , 0.0485816635832483   |
# |-    |-        |MCSE_mse           , 0.00178213992257971 |Mse               , 0.0494775324599181   |
# |-    |-        |%Cov             , 0.868868868868869     |Précision_var     , 0.0131117464247573   |
...
# |n    |Methode     |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:-----------|:----------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Lasso |MCSE_bias          , 0.00863773653309382 |Bias               , -0.0955678543221317 |
# |-    |-           |MCSE_var           , 0.00280316795593388 |Var               , 0.0670748326812142   |
# |-    |-           |MCSE_mse          , 0.0035924095034608   |Mse               , 0.0761334369685352   |
# |-    |-           |%Cov             , 0.794215795328142     |Précision_var    , 0.553747713139878     |
...
# |n    |Methode    |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:----------|:----------------------------------------|:----------------------------------------|
# |5000 |TNDDR_Mars |MCSE_bias          , 0.00844233247405491 |Bias               , -0.0586169043942636 |
# |-    |-          |MCSE_var         , 0.002987876686619     |Var               , 0.0712729776024821   |
# |-    |-          |MCSE_mse           , 0.00351885139493017 |Mse               , 0.0746376461056459   |
# |-    |-          |%Cov , 0.869                             |Précision_var    , -1.17855116586469     |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:--------|:----------------------------------------|:--------------------------------------|
# |5000 |TNDDR_RN |MCSE_bias         , 0.0132474847115552   |Bias              , -0.351293193587334 |
# |-    |-        |MCSE_var           , 0.00428018524082065 |Var             , 0.17549585118289     |
# |-    |-        |MCSE_mse           , 0.00672618258535496 |Mse              , 0.298727263192495   |
# |-    |-        |%Cov , 0.898                             |Précision_var    , -5.66359783086922   |
...
# |n    |Methode   |Erreur de Monte Carlo                    |Autres                                 |
# |:----|:---------|:----------------------------------------|:--------------------------------------|
# |5000 |TNDDR_GLM |MCSE_bias          , 0.00965528220993496 |Bias              , -0.122104160311118 |
# |-    |-         |MCSE_var           , 0.00333416651487388 |Var               , 0.0932244745534865 |
# |-    |-         |MCSE_mse           , 0.00469946620354919 |Mse              , 0.108040676044216   |
# |-    |-         |%Cov, 0.87                               |Précision_var    , 0.148937680118729   |