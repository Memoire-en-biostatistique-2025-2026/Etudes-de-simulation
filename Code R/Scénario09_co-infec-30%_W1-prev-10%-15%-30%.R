...
################################################################################
# Scénario 05 (co-infection ~ 40% dans l'échantillon): Sous-scénario 01 : W1_prev = 10%, 15% et 30% 
#                                                                         
# Pour W1_prev = 30% : co_inf_para1 = 3, co_inf_para2 = 5
# Pour W1_prev = 50% : co_inf_para1 = 3, co_inf_para2 = 5
# Pour W1_prev = 70% : co_inf_para1 = 1, co_inf_para2 = 0.5

################################################################################

################################################################################
################################################################################
# Pour W1_prev = 10% : co_inf_para1 = 3, co_inf_para2 = 5
...
################################################################################
################################################################################
# Pour W1_prev = 15% : co_inf_para1 = 3, co_inf_para2 = 5
# Proportion de co-infection ~30%
...
################################################################################
################################################################################
# Pour W1_prev = 30% : co_inf_para1 = 1, co_inf_para2 = 0.5
# Proportion de co-infection ~30%
...
for (i in 1:nsim) {
  ...
  dat <- datagen.cont(seed = seeds_list[i], popsize = 1000000, W1_prev = 0.3,
...
for (i in 1:nsim) {
  ...
  dat <- datagen(seed = seeds_list[i], ssize = 1000, W1_prev = 0.3,
