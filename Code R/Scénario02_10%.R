...
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |1000 |RegLog  |MCSE_bias         , 0.0025115260015523     |Bias              , 0.0281614500772817   |
# |-    |-       |MCSE_var            , 0.000306176203712253 |Var               , 0.0063077628564733   |
# |-    |-       |MCSE_mse            , 0.000374892556114472 |Mse                , 0.00709452236407205 |
# |-    |-       |%Cov, 0.93                                 |Précision_var      , 0.00446216928161763 |
...
# |n    |Methode |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-------|:------------------------------------------|:----------------------------------------|
# |1000 |IPW     |MCSE_bias          , 0.00266685514211434   |Bias              , 0.0217833891281075   |
# |-    |-       |MCSE_var            , 0.000361951208820118 |Var                , 0.00711211634902168 |
# |-    |-       |MCSE_mse            , 0.000374892556114472 |Mse                , 0.00709452236407205 |
# |-    |-       |%Cov , 0.936                               |Précision_var      , 0.00593548579373557 |
...
# |n    |Methode  |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:--------|:------------------------------------------|:----------------------------------------|
# |1000 |TNDDR_RF |MCSE_bias         , 0.0028738542555705     |Bias               , 0.00123124861258445 |
# |-    |-        |MCSE_var            , 0.000455003244967044 |Var                , 0.00825903828226069 |
# |-    |-        |MCSE_mse            , 0.000456618479106744 |Mse                , 0.00825229521712443 |
# |-    |-        |%Cov , 0.933                               |Précision_var     , 0.0670522041119478   |
...
# |n    |Methode     |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:-----------|:------------------------------------------|:----------------------------------------|
# |1000 |TNDDR_Lasso |MCSE_bias          , 0.00270855952855662   |Bias              , 0.0118855039162817   |
# |-    |-           |MCSE_var            , 0.000371263025338612 |Var                , 0.00733629471973484 |
# |-    |-           |MCSE_mse            , 0.000393060803739929 |Mse                , 0.00747022362835906 |
# |-    |-           |%Cov , 0.872                               |Précision_var     , 0.0499592287943825   |
...
# |n    |Methode    |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:----------|:----------------------------------------|:----------------------------------------|
# |1000 |TNDDR_Mars |MCSE_bias          , 0.00513765843590591 |Bias               , -0.0182516188860471 |
# |-    |-          |MCSE_var          , 0.0017316135569784   |Var               , 0.0263955342040352   |
# |-    |-          |MCSE_mse          , 0.0017383996151407   |Mse               , 0.0267022602617927   |
# |-    |-          |%Cov , 0.933                             |Précision_var   , 0.25316719485075       |
...
# |n    |Methode  |Erreur de Monte Carlo                    |Autres                                   |
# |:----|:--------|:----------------------------------------|:----------------------------------------|
# |1000 |TNDDR_RN |MCSE_bias          , 0.00758380671749473 |Bias               , -0.0623004590024635 |
# |-    |-        |MCSE_var           , 0.00257376668408698 |Var               , 0.0575141243283182   |
# |-    |-        |MCSE_mse          , 0.0026422851016306   |Mse               , 0.0613379573959075   |
# |-    |-        |%Cov , 0.919                             |Précision_var    , 0.103431358350089     |
...
# |n    |Methode   |Erreur de Monte Carlo                      |Autres                                   |
# |:----|:---------|:------------------------------------------|:----------------------------------------|
# |1000 |TNDDR_GLM |MCSE_bias          , 0.00281487201409883   |Bias              , 0.0163702447157114   |
# |-    |-         |MCSE_var            , 0.000405068893019523 |Var               , 0.0079235044557568   |
# |-    |-         |MCSE_mse            , 0.000446301351168034 |Mse                , 0.00818356586335332 |
# |-    |-         |%Cov , 0.951                               |Précision_var      , 0.00126734824429695 |